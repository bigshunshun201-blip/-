...
4. 语境优先按《洛克王国：世界》手游/开放世界处理：探索、传送点、精灵互动、收集、区域首领、隐藏宝藏、开放地图任务；页游老场景只能作为怀旧彩蛋。
5. 不要声称官方授权，不要写成官方宣传。
...
4. 必须使用手游场景「${payload.scene || "用户未指定场景"}」作为主要发生地；没有指定时，按《洛克王国：世界》开放世界区域处理。
5. 前 3 秒强钩子；结尾留下下一集钩子；台词短句可拍。
6. 输出要精简，避免长段落。
${previous}
...
function buildTopicsPrompt(input) {
  ...
  const petReference = [
    "喵喵 / 魔力猫：草系初始精灵，适合月牙镇、普拉塔草原、吐槽和治愈反差",
    "火花 / 火神：火系初始精灵，适合普拉塔草原、区域首领误会、冲动救场",
    "水蓝蓝 / 水灵：水系初始精灵，适合海上浪花基地、天水镇、冷脸补刀",
    "迪莫：光系伙伴，适合怀旧主线，但不要每条都用它",
    "皇家狮鹫 / 小狮鹫：飞行精灵，适合聆风塔、旧飞艇航道、高傲反差和救场",
    "雪影娃娃 / 幽兰雪魅：冰系人气精灵，适合风熄山口、奥贝斯坦湖、冷脸护短",
    "呱呱 / 熊猫拳宗：武系功夫精灵，适合风眠圣所、动作喜剧、打断吟唱",
    "小灵灵 / 九幽菇：幽灵或怪谈气质精灵，适合沉船漩涡、拾荒港口、夜间整活",
    "立方人 / 先锋君主：机械精灵，适合旧飞艇航道、数据吐槽、系统故障",
    "眠枭之星：聆风塔相关谜题精灵，适合塔顶风眼、收集任务、悬疑",
    "翡翠水母：海上浪花基地或水域探索，适合异常信号、发光线索",
    "小帕尔 / 龙息帕尔：龙系成长线，适合风眠圣所、首领挑战、成长爽点",
    "阿布 / 超能阿布：高人气精灵，适合关键救场、伙伴羁绊、系列主线",
  ];
  ...
  return `
你是短视频短剧选题策划。请为《洛克王国：世界》手游/开放世界语境的粉丝向二创短剧生成一批全新的选题候选。
...
7. 必须构建更丰富的《洛克王国：世界》手游世界，优先使用手游开放世界区域、探索点、传送点、收集/首领/BOSS/精灵互动等语境。
8. 不要把页游老地图当主场景；魔法学院、人鱼湾、威廉古堡等只可作为“怀旧回归/彩蛋场景”少量使用。
9. 每条必须返回 roles，格式为“角色A：说明；精灵B：说明；反派/冲突源C：说明”，后续生成剧本会直接使用它。
10. 可以借鉴 topicReference / competitorInsights，但不要写成竞品分析。
