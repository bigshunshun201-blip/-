(function (root, factory) {
  ...
  const aiModelScopes = ["meme", "mix", "plan", "beat", "script", "storyboard", "bible", "episodeBible", "character", "continuity", "topics", "ledger", "doctor", "recast"];
  ...
  const aiModelScopeLabels = {
    ...
    script: "剧本", storyboard: "分镜", bible: "系列总圣经", episodeBible: "本次创作圣经", character: "角色卡",
